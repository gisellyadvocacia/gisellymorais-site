  ...
  return (
    <header className={`navbar${scrolled ? ' scrolled' : ''}`}>
      <div className="container navbar-inner">
        <Link href="/#inicio" className="nav-logo" aria-label="Dra. Giselly Morais Advocacia - Ir para o início" onClick={close}>
          <Image
        ...
        <nav className={`nav-links${open ? ' active' : ''}`} aria-label="Menu principal de navegação">
        ...
        <div className="nav-actions">
          <a
            ...
            aria-label="Iniciar atendimento no WhatsApp da Dra. Giselly Morais"
          >
