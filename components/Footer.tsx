        ...
        <div className="footer-grid">
          <div className="footer-brand">
            ...
            <div className="social-icons-wrap" style={{ marginTop: 20 }}>
              <a
                ...
                aria-label="Instagram da Dra. Giselly Morais"
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                className="social-link-btn"
                aria-label="Facebook da Dra. Giselly Morais"
              >
                <svg viewBox="0 0 24 24">
              ...
              <a
                ...
                rel="noopener noreferrer"
                className="social-link-btn"
                aria-label="LinkedIn da Dra. Giselly Morais"
              >
                <svg viewBox="0 0 24 24">
          ...
          <div className="footer-nav">
            ...
            <ul className="footer-links">
              ...
              <li><Link href="/#ebook">Ebook &amp; Checklist</Link></li>
          ...
          <div className="footer-contact">
            ...
            <p className="footer-contact-item">
              ...
              <a href="https://wa.me/5534992881500" target="_blank" rel="noopener noreferrer">
                (34) 99288-1500
              </a>
            </p>
            <p className="footer-contact-item">
              ...
              <a href="mailto:gisellyadvocacia@gmail.com">
            ...
            <div className="footer-location-card">
              <div className="footer-location-info">
                <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="footer-pin-svg">
